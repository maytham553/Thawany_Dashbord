...
function Pagination(props: Props) {
    ...
    return <>
        <div className="flex  items-center justify-center py-5 h-20 lg:px-0  center w-5/6	 absolute bottom-0 right-0   bg-white shadow">
            <div className="lg:w-3/5 w-full  flex items-center justify-between border-t border-gray-200 dark:border-gray-700 ">
                {!(thisPage === 1) ?
                    ...
                    <button disabled onClick={goToPrevPage} className="flex items-center pt-3 text-gray-300 dark:text-gray-200   cursor-pointer text-sm ml-3 font-medium leading-none">
                        Previous
                    </button>
                }
                ...
                {!(totalPages === thisPage) ?
                    ...
                    :
                    <button disabled onClick={goToNextPage} className="flex items-center pt-3 text-gray-300 dark:text-gray-200   cursor-pointer text-sm font-medium leading-none mr-3">
                        Next
                    </button>
                }
            </div>
